\begin{abstract}
	The travelling salesman problem (TSP) is an NP hard combinatorial optimisation problem,
	that asks for the shortest possible route that visits a set of cities
	and returns to the starting city. Solving TSPs exactly using brute-force methods
	quickly becomes computationally infeasible as the number of cities increases.
	...
	2-Opt, Iterated Local Search and a Genetic Algorithm. Algorithms are evaluated
	using synthetic benchmark TSP instances of sizes \(n \in \{10, 25, 50, 100, 200, 500, 800, 1\,000, 1\,500, 2\,000\}\) with 30
